...
public class WindowBuilder {
  public static void main(String[] args) {
     ...
     OnFocusEventHelper.setOnFocusText(name, "First Last", Color.decode("#1b1b1b"),   Color.decode("#737674"));
     panel.add(name);
     ...
     OnFocusEventHelper.setOnFocusText(course, "XXXX000", Color.decode("#1b1b1b"),   Color.decode("#737674"));
     panel.add(course);
     ...
     OnFocusEventHelper.setOnFocusText(credits, "0", Color.decode("#1b1b1b"),   Color.decode("#737674"));
     panel.add(credits);
     ...
     OnClickEventHelper.setOnClickColor(submit, Color.decode("#c2c2c2"), Color.decode("#ffffff"));
     panel.add(submit);

     submit.addActionListener(new ActionListener() {
        @Override
        public void actionPerformed(ActionEvent e) {
          String data = name.getText() + " " + course.getText() + " " + credits.getText();
